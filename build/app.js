...
const findAllPrime = (max) => __awaiter(void 0, void 0, void 0, function* () {
...
const findMedianOfPrime = (primeNum) => __awaiter(void 0, void 0, void 0, function* () {
    return new Promise((res, rej) => {
        try {
...
app.get('/medianPrime/:number', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    findAllPrime(+req.params.number).then((primeNums) => findMedianOfPrime(primeNums).then((medianNums) => res.json(medianNums)))
        .catch(next);
}));
